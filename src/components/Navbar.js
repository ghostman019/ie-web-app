  ...
  return (
    <div className="navbar">
      <div className="navbar-left">
        <img src="/path/to/ie-logo.png" alt="IE Logo" className="navbar-logo" />
        <span className="navbar-title">Internet Explorer</span>
      </div>
      <div className="navbar-right">
        <img src="/path/to/back-icon.png" alt="Back" className="navbar-icon" />
        <img src="/path/to/forward-icon.png" alt="Forward" className="navbar-icon" />
